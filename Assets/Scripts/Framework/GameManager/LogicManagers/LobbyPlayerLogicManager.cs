...
namespace Framework.GameManagerFramework.LogicManagers
{
    ...
    public class LobbyPlayerLogicManager : ILogicBehaviour
    {
        ...
        {
            _lobbyPlayerDataManager = GameManager.Core.World.GetExitsDataManager<LobbyPlayerDataManager>();
            _lobbyPlayerMessageManager = GameManager.Core.World.GetExitsMessageManager<LobbyPlayerMessageManager>();
        ...
        private void OnLocalEntryLobby(StateSyncData selfData , List<StateSyncData> resOtherPlayerData)
        {
            ...
            nameControl.Init(_lobbyPlayerDataManager.SelfPlayer.PlayerName , GameManager.Core.World.GetExitsLogicManager<TP_CameraLogicManager>().cameraControl.gameObject.transform);
            ...
            foreach (var playerData in resOtherPlayerData)
            {
                ...
                player.GetComponent<LobbyPlayerName>().Init(playerData.PlayerName , GameManager.Core.World.GetExitsLogicManager<TP_CameraLogicManager>().cameraControl.gameObject.transform);
                //同步其他玩家位置和方向
